        ...
        <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
            <div className="md:max-w-96">
                ...
                <p className="mt-6 text-sm">
                    ContentAI is your go-to platform for AI-powered content creation. <br /> We provide a suite of tools to help you create, enhance, and optimize your content effortlessly.
                </p>
            </div>
